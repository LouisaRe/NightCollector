...
public class SoundPlayer {
  ...
  final String musicFileName = "sound-ararat-deep.mp3"; // Music from a band of mine: https://andreasmusic.ch/ararat-quintet
